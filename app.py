...
def get_summary_from_input_text(text,force_use_purnabiram_model):
    return get_summary_from_text(text,force_use_purnabiram_model)
...
async def getSummarize(text):
    return {"text":get_summary_from_input_text(text,force_use_purnabiram_model)}
